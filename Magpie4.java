...
public class Magpie4 {
	...
	// method that transforms I want statement --> heavily referenced from the I
	// want statement
	private String transformIWantStatement(String statement) {
		...
		String restOfStatement = statement.substring(psn + 6).trim(); // +6 to include everything after I want
		return "Would you really be happy if you had " + restOfStatement + "?";
	}

	// method that transforms I 'something' you statement --> heavily referenced
	// from the YouMe statement
