...
public class Magpie2 {
	...
	public String getResponse(String statement) {
		...
		if (statement.trim().length() == 0) {
		...
		} else if (statement.indexOf("Krasteva") >= 0) {
			response = "She's the best teacher, that's for sure.";
			...
			response = "It's a good thing be happy!";
		} else if (statement.indexOf("game") >= 0) {
			response = "Tell me more about this game.";
		} else if (statement.indexOf("broccoli") >= 0) {
			response = "Yikes... any other greens?";
		} else {
